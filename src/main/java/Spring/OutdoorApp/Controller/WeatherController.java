...
public class WeatherController {
    ...
    public WeatherController(ActualWeatherRepository repository, ActivityRepository activityRepository, CaloriesRepository caloriesRepository, RequirementsService requirementsService) throws IOException {
